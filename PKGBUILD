...
build() {
  ...
  install -Dm 644 'FixedMediumLispm-13.pcf.gz' "${pkgdir}/usr/share/fonts/misc/FixedMediumLispm-13.pcf.gz"
  install -Dm 644 'lispm-8x14.psf' "${pkgdir}/usr/share/kbd/consolefonts/lispm-8x14.psf"
